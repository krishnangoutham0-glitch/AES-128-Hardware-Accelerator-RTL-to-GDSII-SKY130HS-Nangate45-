...
% if user_peripheral_domain.contains_peripheral('aes'):
  aes #(
      .reg_req_t(reg_req_t),
      .reg_rsp_t(reg_rsp_t)
  ) aes_i (
      .clk_i(clk_cg),
      .rst_ni,
      .reg_req_i(peripheral_slv_req[core_v_mini_mcu_pkg::AES_IDX]),
      .reg_rsp_o(peripheral_slv_rsp[core_v_mini_mcu_pkg::AES_IDX])
  );
% endif
