module key_expansion (
  ...
  always @* begin
    ...
    t = {w3[23:16], w3[15:8], w3[7:0], w3[31:24]};
  ...
  function automatic logic [7:0] rcon_next(input logic [7:0] r);
    begin
      if (r[7]) rcon_next = {r[6:0], 1'b0} ^ 8'h1B;
      else rcon_next = {r[6:0], 1'b0};
    end
  endfunction
